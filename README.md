...
> The v2.4.2 candidate records Circadian and Quality decisions without changing production delivery. Real blocking is guarded by two isolated-test-only keys until fresh-container and real spare-WeChat acceptance are complete.
