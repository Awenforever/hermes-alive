...
PYTHONDONTWRITEBYTECODE=1 python3 "$ROOT/tests/run_editorial_discovery_v4.py"
PYTHONDONTWRITEBYTECODE=1 python3 "$ROOT/tests/run_editorial_quality_contract_v1.py"
PYTHONDONTWRITEBYTECODE=1 python3 "$ROOT/tests/run_delivery_backpressure.py"
PYTHONDONTWRITEBYTECODE=1 python3 "$ROOT/tests/run_discovery_once_control.py"
PYTHONDONTWRITEBYTECODE=1 python3 "$ROOT/tests/run_runtime_import_precedence.py"
PYTHONDONTWRITEBYTECODE=1 python3 "$ROOT/tests/run_semantic_policy_repair.py"
PYTHONDONTWRITEBYTECODE=1 python3 "$ROOT/tests/run_delivery_failure_cooldown.py"
