...
def save_diff(diff: DreamDiff, path: str | None = None) -> str:
    ...
    target = path or os.getenv("DREAM_DIFF_PATH", os.path.join(os.getenv("HERMES_HOME", os.path.join(os.path.expanduser("~"), ".hermes")), "plugin-data", "hermes-alive", "runtime", "dream_diff.json"))
